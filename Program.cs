...
app.MapPost("/parse", async (HttpRequest request) =>
{
    ...
    var resultado = ExtrairCampos(texto);
...
record ResumoRequest([property: JsonPropertyName("ResumoConversa")] string ResumoConversa);
...
static ParseResult ExtrairCampos(string texto)
{
